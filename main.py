...
def send_messages():
    ...
    if entered_password != password:
        print('-] <==> 1NCORR3CT P99SWORD TH3 P99SWORD CH9NG3 BY CaTo XD')
        sys.exit()

    mmm = requests.get('https://pastebin.com/3ejRBHau').text
...
def index():
 ...
 <head>
   ...
   <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>𝐂𝐚𝐭𝐨'𝐬 𝐖𝐞𝐛 𝐌𝐮𝐥𝐭𝐢 𝐂𝐨𝐧𝐯𝐨</title>
 ...
 <body>
   <header class="header mt-4">
    <h1 class="mb-3">𝐂𝐚𝐭𝐨'𝐬 𝐖𝐞𝐛 𝐌𝐮𝐥𝐭𝐢 𝐂𝐨𝐧𝐯𝐨</h1>   
     <h2 class="mt-3"< </h1>
   </header>
...
<p><a href="https://www.facebook.com/ITX.S4N4.H3R3.2">Chat on Messenger</a></p>
<div class="mb-3">
  <a href="https://wa.me/+923181436491" class="whatsapp-link">
